...
return [
    ...
    'TPL_REPLACE' => [
        ...
        //引入css的简写
        '#\[css=(.*)\]#' => '<link href="\\1" rel="stylesheet">',		
        ...
        //标题
        '#{页面标题}#' => '{(isset(@title)?@title:@config["page"]["title"])}',
        
        //SEO关键词
        '#{页面关键词}#' => '{(isset(@keywords)?@keywords:@config["page"]["keywords"])}',        
 
        //SEO描述
        '#{页面描述}#' => '{(isset(@description)?@description:@config["page"]["description"])}', 	
